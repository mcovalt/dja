...
class QueryStringField(serializers.BaseSerializer):
    ...
    def validate_value(self, value: Union[List[str], str]) -> Union[List[str], str]:
        """Validates and returns the query value."""
        return value

    def validate(self, querydict: Dict[str, List[Union[List[str], str]]]) -> Dict[str, List[Union[List[str], str]]]:
    ...
    def represent_value(self, value: Union[List[str], str]) -> Union[List[str], str]:
        """Gets the representation of the query value."""
        return value

    def represent(self, querydict: Dict[str, List[Union[List[str], str]]]) -> Dict[str, List[Union[List[str], str]]]:
    ...
    def to_internal_value(self, querydict: QueryDict) -> Dict[str, List[Union[List[str], str]]]:
    ...
    def to_representation(
        ...
        for key, value in out.items():
            ...
            if self.flatten:
                escaped_value = [[quote_plus(v) for v in i] for i in value]
            else:
                escaped_value = [quote_plus(v) for v in value]  # type: ignore
